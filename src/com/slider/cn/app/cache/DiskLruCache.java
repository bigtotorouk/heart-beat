...
public class DiskLruCache {
    ...
    private void flushCache() {
        ...
        while (count < MAX_REMOVALS &&
        	...
        	/* add by slider 2012-8-22 
        	 * beacause 'that this isn't keeping track of stale files in the cache directory that aren't in the
        	 * HashMap '. that is to say, it doesn't work when the HashMap has no item. so it clear the cache(all file in cache dir) 
        	 * */
