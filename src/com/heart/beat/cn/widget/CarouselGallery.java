...
/**
 * 这个类实现的gallery的轮播的效果，有很多地方跟gallery3d很类似
 * @author ken
 */
public class CarouselGallery extends Gallery {
	...
	public CarouselGallery(Context context, AttributeSet attrs) {
	  super(context, attrs);
	  this.setStaticTransformationsEnabled(true);
	}
	public CarouselGallery(Context context, AttributeSet attrs, int defStyle) {
